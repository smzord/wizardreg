...
function Subscription() {
  ...
  const handleSelect = (e) => {
    console.log($(e).html());
    // var dt = e.target.getAttribute("data-type").value;
    // var id = e.target.getAttribute("data-id").value;
    // if(dt == 'plan'){
    //   setPlan(id);
    // }else if(dt == 'place'){
    //   setPlace(id);
    ...
    //   setPlacetype(id);
    // }
    // console.log(plan+' '+place+' '+placetype)
  }
                  ...
                  <div className="step1">
                    ...
                    <div className="step1Body">
                      <div className="step1Planselection">
                        <div className="planselect" data-type="plan" data-id="a0v5e000001SHhMAAW" onClick={handleSelect}>
                          <div className="planselectRadio">
                            <input type="radio" name="plan" value="$70" id="pickPlan70"  />
                            <label htmlFor="pickPlan70">$70 per month</label>
                          </div>
                          <span>24-month term after free trial</span>
                        </div>
                        <div className="planselect" data-type="plan" data-id="a0v5e000001SHhOAAW" onClick={handleSelect}>
                          <div className="planselectRadio">
                            <input type="radio" id="pickPlan80" name="plan" value="$80"  />
                            <label htmlFor="pickPlan80">$80 per month</label>
                          </div>
                    ...
                    <div className="step2Body">
                      <div className="step2Planselection">
                        ...
                        <div className="placeOption">
                          <div className="optionSection" data-type="place" data-id="Home" onClick={handleSelect}>
                            <img src="img/home.png" />
                            <input type="radio" name="place" id="placeHome" hidden/>
                            <label htmlFor="placeHome">Home</label>
                         </div>
                          <div className="optionSection" data-type="place" data-id="Townhouse" onClick={handleSelect}>
                            <img src="img/town.png" />
                            <input type="radio" name="place" id="placeTown" hidden />
                            <label htmlFor="placeTown">Townhouse</label>
                         </div>
                          <div className="optionSection" data-type="place" data-id="Apartment" onClick={handleSelect}>
                            <img src="img/apartment.png" />
                            <input type="radio" name="place" id="placeApartment" hidden />
                            <label htmlFor="placeApartment">Apartment</label>
                         </div>
                        </div>
                      </div>
                      <div className="step2Planselection">
                        ...
                        <div className="placeOption">
                          <div className="placeselect" data-type="place_type" data-id="Own" onClick={handleSelect}>
                            <div className="placeselectRadio">
                              <input type="radio" name="place_type" value="Own" id="kindPlaceOwn"/>
                              <label htmlFor="kindPlaceOwn">Own</label>
                              {/* <span className="spanClassOwn"></span> */}
                           </div>
                          </div>
                          <div className="placeselect" data-type="place_type" data-id="Rent" onClick={handleSelect}>
                            <div className="placeselectRadio">
                              <input type="radio" name="place_type" value="Rent" id="kindPlaceRent"/>
                              <label htmlFor="kindPlaceRent">Rent</label>
