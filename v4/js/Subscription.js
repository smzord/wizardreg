                      ...
                      <div className="step1Planselection">
                        <div className="planselect">
                          <div className="planselectRadio">
                            ...
                            <label htmlFor="html" for="pickPlan70">$70 per month</label>
                          </div>
                        ...
                        <div className="planselect">
                          <div className="planselectRadio">
                            ...
                            <label htmlFor="html" for="pickPlan80">$80 per month</label>
                          </div>
                        ...
                        <div className="placeOption">
                          <div className="placeselect">
                            <div className="placeselectRadio">
                              <input type="radio" name="plan" value="Own" id="kindPlaceOwn"/>
                              <label htmlFor="Own" for="kindPlaceOwn">Own</label>
                              {/* <span className="spanClassOwn"></span> */}
                           </div>
                          </div>
                          <div className="placeselect">
                            <div className="placeselectRadio">
                              <input type="radio" name="plan" value="Rent" id="kindPlaceRent"/>
                              <label htmlFor="Rent" for="kindPlaceRent">Rent</label>
